                ...
                <div className="team-container">
                    <div className="team-info">
                        <div class='pic-zoom'>
                            ...
                            <p>WCT</p>
                            <a className="instagram" class='tooltip' href="https://www.instagram.com/koloheandino22/?hl=en"><i class="fab fa-instagram fa-2x" ><span class="tooltiptext">Follow on Instagram</span></i></a>
                        </div>  
                        <div>
                            ...
                            <a className="instagram" class='tooltip' href="https://www.instagram.com/cocom4debarrelkilla/?hl=en"><i class="fab fa-instagram fa-2x" ><span class="tooltiptext">Follow on Instagram</span></i></a>
                        </div>  
                        <div>
                            ...
                            <a className="instagram" class='tooltip' href="https://www.instagram.com/rissmoore10/?hl=en"><i class="fab fa-instagram fa-2x" ><span class="tooltiptext">Follow on Instagram</span></i></a>
                        </div>  
                        <div>
                            ...
                            <a className="instagram" class='tooltip' href="https://www.instagram.com/tajamos/?hl=en"><i class="fab fa-instagram fa-2x" ><span class="tooltiptext">Follow on Instagram</span></i></a>
                        </div>  
                    </div>
                </div>
            </div>
